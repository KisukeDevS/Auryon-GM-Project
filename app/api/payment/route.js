...
export async function POST(req) {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "payment",
      success_url: `http://auryon.vercel.app/Payment-success?session_id={CHECKOUT_SESSION_ID}&tuserName=${encodeURIComponent(jsonData.userName)}&comments=${encodeURI(jsonData.comment)}`,
      cancel_url: "http://auryon.vercel.app/payment-cancel",
    });
