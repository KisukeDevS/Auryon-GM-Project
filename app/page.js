...
const itemVariants = {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.h1
         ...
         whileInView={{ opacity: 1, y: 0, scale: 1 }}
          transition={{ delay: 0.2, duration: 0.7, ease: "easeInOut" }}
          className="text-6xl md:text-8xl font-extrabold bg-gradient-to-br from-[#005CFF] via-[#B94FFF] to-[#00E0FF] bg-clip-text text-transparent 
        ...
        >
          <Link
          href = "/Login"
            className="px-5 py-3 rounded-lg text-[1.4vh] sm:text-sm font-bold w-[25vw] sm:w-[20vw] md:w-[15vw] lg:w-[10vw] h-[50px]
      ...
      >
        <h2 className="font-extrabold text-3xl mb-10 bg-gradient-to-r from-[#004BE1] to-[#00CFFF] bg-clip-text text-transparent">
          More About Us
        </h2>
